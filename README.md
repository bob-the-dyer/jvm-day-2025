...
Ужасная погрешность
Давай перепроверим на jlbh на вирт фил на скейле по кол-ву фил

| reentrant |              jmh | jlbh: лучший 90% |
|----------:|-----------------:|-----------------:|
|    1К 10К |    16 ±    78 ms |    1700 ms (15%) |
|   10К 10К |   153 ±    75 ms |   17414 ms (13%) |
|  100К 10К |  1542 ±  2511 ms |  187099 ms (??%) |
| 1000К 10К | 22066 ± 32925 ms | 1582292 ms (??%) |
