package ru.spb.kupchinolab.jvmday2025.dining_philosophers._013_jmh_benchmarks_vertx_blocking_reading;
...
public class BlockingReadingVerticlePhilosophersBenchmark {
    ...
    public void test_verticle_blocking_reading_philosophers(Blackhole blackhole) throws InterruptedException {
        test_verticle_philosophers_internal(VerticlePhilosopher::from, constructBlockingReadingEating(blackhole), new DeploymentOptions());
    }
