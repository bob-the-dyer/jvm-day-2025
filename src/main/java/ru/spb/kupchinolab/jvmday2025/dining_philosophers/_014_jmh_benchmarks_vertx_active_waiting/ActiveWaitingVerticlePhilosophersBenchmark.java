package ru.spb.kupchinolab.jvmday2025.dining_philosophers._014_jmh_benchmarks_vertx_active_waiting;
...
@State(Scope.Thread)
public class ActiveWaitingVerticlePhilosophersBenchmark {
    ...
    @Benchmark
    public void test_verticle_active_waiting_philosophers(Blackhole blackhole) throws InterruptedException {
        test_verticle_philosophers_internal(VerticlePhilosopher::from, constructActiveWaitingEating(blackhole), new DeploymentOptions());
    }
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(ActiveWaitingVerticlePhilosophersBenchmark.class.getSimpleName())
                .forks(1)
                .warmupIterations(1)
