package ru.spb.kupchinolab.jvmday2025.dining_philosophers._120_jmh_benchmarks_vertx_noop;
...
import ru.spb.kupchinolab.jvmday2025.dining_philosophers._100_vertx_pivot.FatVirtualVerticlePhilosopher;
...
@State(Scope.Thread)
public class NoopFatVirtualVerticlePhilosophersBenchmark {
    ...
    public void test_virtual_noop_verticle_philosophers(Blackhole blackhole) throws InterruptedException {
        test_verticle_philosophers_internal(FatVirtualVerticlePhilosopher::from, constructNoopEating(blackhole), new DeploymentOptions().setThreadingModel(VIRTUAL_THREAD));
    }
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(NoopFatVirtualVerticlePhilosophersBenchmark.class.getSimpleName())
                .forks(1)
                .warmupIterations(3)
