...
public class BlockingReadingPhilosophersSynchronizedVirtualThreadsBenchmark implements JLBHTask {
    ...
    public void test_synchronized_blocking_reading_philosophers_with_virtual_threads(NanoSampler eatingSampler) throws InterruptedException, BrokenBarrierException {
        test_philosophers_internal(Thread.ofVirtual().factory(), SynchronizedPhilosopher::from, constructBlockingReadingEating(), eatingSampler);
    }
    ...
    public static void main(String[] args) {
        JLBHOptions lth = new JLBHOptions()
                ...
                .jlbhTask(new BlockingReadingPhilosophersSynchronizedVirtualThreadsBenchmark());
        new JLBH(lth).start();
    }
    ...
    public void run(long startTimeNS) {
        try {
            test_synchronized_blocking_reading_philosophers_with_virtual_threads(eatingSampler);
