package ru.spb.kupchinolab.jvmday2025.dining_philosophers._050_jmh_benchmarks_jdk;
...
public class SynchronizedPhilosophersBenchmark {
    ...
    private void test_philosophers_internal(ThreadFactory factory, Consumer<Integer> eating) throws InterruptedException, BrokenBarrierException {
        ...
        for (int i = 0; i < PHILOSOPHERS_COUNT_BASE; i++) {
            ...
            synchronizedPhilosophers.add(new SynchronizedPhilosopher(i, leftChopstick, rightChopstick, barrier, eating));
        }
