...
public class OkHttpPhilosophersReentrantLockPlatformThreadsBenchmark implements JLBHTask {
    ...
    public void test_reentrant_lock_blocking_reading_philosophers_with_platform_threads(NanoSampler eatingSampler) throws InterruptedException, BrokenBarrierException {
        test_philosophers_internal(Thread.ofPlatform().factory(), ReentrantPhilosopher::from, constructOkHttpEating(), eatingSampler);
    }
    ...
    public static void main(String[] args) {
        JLBHOptions lth = new JLBHOptions()
                ...
                .jlbhTask(new OkHttpPhilosophersReentrantLockPlatformThreadsBenchmark());
        new JLBH(lth).start();
    }
