...
public class BlockingReadingPhilosophersReentrantLockPlatformThreadsBenchmark implements JLBHTask {
    ...
    public void test_reentrant_lock_blocking_reading_philosophers_with_platform_threads(NanoSampler eatingSampler) throws InterruptedException, BrokenBarrierException {
        test_philosophers_internal(Thread.ofPlatform().factory(), ReentrantPhilosopher::from, constructBlockingReadingEating(), eatingSampler);
    }
    ...
    public static void main(String[] args) {
        JLBHOptions lth = new JLBHOptions()
                ...
                .jlbhTask(new BlockingReadingPhilosophersReentrantLockPlatformThreadsBenchmark());
        new JLBH(lth).start();
    }
    ...
    public void init(JLBH jlbh) {
        this.jlbh = jlbh;
        eatingSampler = jlbh.addProbe("eating with ReentrantLock+PlatformThreads");
    }

    @Override
    public void run(long startTimeNS) {
        try {
            test_reentrant_lock_blocking_reading_philosophers_with_platform_threads(eatingSampler);
