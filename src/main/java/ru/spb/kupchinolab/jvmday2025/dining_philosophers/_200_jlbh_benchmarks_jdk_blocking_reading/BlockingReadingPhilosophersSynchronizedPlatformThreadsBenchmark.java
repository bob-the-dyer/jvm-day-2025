...
public class BlockingReadingPhilosophersSynchronizedPlatformThreadsBenchmark implements JLBHTask {
    ...
    public void test_synchronized_blocking_reading_philosophers_with_platform_threads(NanoSampler eatingSampler) throws InterruptedException, BrokenBarrierException {
        test_philosophers_internal(Thread.ofPlatform().factory(), SynchronizedPhilosopher::from, constructBlockingReadingEating(), eatingSampler);
    }
    ...
    public static void main(String[] args) {
        JLBHOptions lth = new JLBHOptions()
                ...
                .jlbhTask(new BlockingReadingPhilosophersSynchronizedPlatformThreadsBenchmark());
        new JLBH(lth).start();
    }
    ...
    public void run(long startTimeNS) {
        try {
            test_synchronized_blocking_reading_philosophers_with_platform_threads(eatingSampler);
