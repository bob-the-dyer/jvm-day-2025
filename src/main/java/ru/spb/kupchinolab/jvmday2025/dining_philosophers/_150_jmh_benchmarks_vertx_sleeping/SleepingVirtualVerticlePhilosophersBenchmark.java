package ru.spb.kupchinolab.jvmday2025.dining_philosophers._150_jmh_benchmarks_vertx_sleeping;
...
@State(Scope.Thread)
public class SleepingVirtualVerticlePhilosophersBenchmark {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(SleepingVirtualVerticlePhilosophersBenchmark.class.getSimpleName())
                .forks(1)
                .warmupIterations(3)
