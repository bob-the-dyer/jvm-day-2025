...
public class UnitedPhilosophersTest {
    ...
    private void test_philosophers_internal(ThreadFactory factory) throws InterruptedException, BrokenBarrierException {
