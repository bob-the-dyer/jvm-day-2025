...
public class ReentrantLockPhilosophersTest {
    ...
    void test_reentrant_lock_philosophers_with_virtual_threads() throws InterruptedException, BrokenBarrierException {
        test_reentrant_lock_philosopher_internal(Thread.ofVirtual().factory());
    }

    @RepeatedTest(100)
    void test_reentrant_lock_philosophers_with_platform_threads() throws InterruptedException, BrokenBarrierException {
        test_reentrant_lock_philosopher_internal(Thread.ofPlatform().factory());
    }

    private void test_reentrant_lock_philosopher_internal(ThreadFactory factory) throws InterruptedException, BrokenBarrierException {
